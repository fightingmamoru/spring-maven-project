...
public class JsonUtilTest
{
	...
	public void test()
	{
		...
		// List<Map<String, Object>> treeList = JsonUtil.convertTreeMap(dataList, "0", "mngr_resrce_id", "upper_mngr_resrce_id");
		// System.out.println("[Data Check]" +  JSONArray.toJSONString(treeList));
