...
public class PrintMaleInfo implements JavaDelegate
{
	@Override
	public void execute(DelegateExecution delegateExecution) throws Exception
	{
		...
		// print variable
		System.out.println("[SecondProcess - PrintMaleInfo] processInstanceId : " + delegateExecution.getProcessInstanceId() +
				" / name : " + name +
				" / age : " + age +
				" / gender : " + gender);
	}
